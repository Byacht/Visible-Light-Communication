...
public class ImageThread {
    ...
    public interface GetLedCount {
        int getCount();
    }

    GetLedCount getLedLineCount;

    public void setGetLedLineCountListener(GetLedCount getLedCount) {
        this.getLedLineCount = getLedCount;
    }
